...
const cvsFiltration = (arr) => {
    return arr.filter(el => {
        return el.yearsOfExperience > 4 && el.tech === 'JS';
    }).map(el => {
        const fullName = `${el.firstName}${el.LastName ? ' ' + el.LastName : ''}`;
        return { fullName, tech: el.tech };
    });
}
// -------------------------------------------------------------------------------------------------------
...
const vowelsFiltration = (arr) => {
    ...
    return arr.filter(el => !vowel.test(el));
}
// -------------------------------------------------------------------------------------------------------
